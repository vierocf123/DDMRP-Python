...
def def_exportar_planejado_PBI(df_dado_mestre, df_custo, df_parametros,
    ...
    #Regra PMP
    plano_PMP = (df_completo["FLUXO_LIQUIDO"]
                 .div(df_completo["DEMANDA_PF_D1"])
                 .where(df_completo["DEMANDA_PF_D1"] != 0, 1))
    ...
    df_completo.loc[mask_PMP, "EXECUCAO_BUFFER"] = (df_completo.loc[mask_PMP, "EST_QTD"]
                                                      .div(df_completo.loc[mask_PMP, "DEMANDA_PF_D1"])
                                                      .where(df_completo.loc[mask_PMP, "DEMANDA_PF_D1"] != 0, 1))    
    ...
    diff = df_completo['EST_QTD'] - df_completo['DEMANDA_PF_D1']
