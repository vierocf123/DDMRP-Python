...
if __name__ == "__main__":
    ...
    df_ajuste, df_dados_mestres, lista_de_materiais_DDMRP = def_ler_dados_de_ajuste(base_dir,
    ...
    arr_consumo_demanda, arr_OCs_OPs, arr_NIPs_completo, arr_reservas_completo, arr_DAF, df_demanda, df_consumo = def_vetorizar_dados(lista_de_materiais_DDMRP, lista_dias_bloqueados,
    ...
    df_parametros, arr_planejado, arr_planejado_entrega, lista_DDMRP_fluxo, lista_DDMRP_completo, lista_DDMRP_fluxo_DIAS, lista_DDMRP_completo_DIAS = def_calcular_planejamento(data_ref, data_ref_consumo_i, data_ref_carteira_f, lista_dias_bloqueados,
                                                                                                                                                                                ...
                                                                                                                                                                                arr_consumo_demanda, arr_DAF, arr_reservas_completo, lista_de_materiais_DDMRP)
    ...
    #Exportar vetores em D+1
    def_exportar_vetor(arr_TOG, lista_DDMRP_fluxo, lista_de_materiais_DDMRP, base_dir, r"4.Relatorios Python", "TOG.xlsx", "D1")
    def_exportar_vetor(arr_TOY, lista_DDMRP_fluxo, lista_de_materiais_DDMRP, base_dir, r"4.Relatorios Python", "TOY.xlsx", "D1")
    def_exportar_vetor(arr_TOR, lista_DDMRP_fluxo, lista_de_materiais_DDMRP, base_dir, r"4.Relatorios Python", "TOR.xlsx", "D1")
    def_exportar_vetor(arr_ADU, lista_DDMRP_fluxo, lista_de_materiais_DDMRP, base_dir, r"4.Relatorios Python", "ADU.xlsx", "D1")
    def_exportar_vetor(arr_DEMANDA_QUALIFICADA, lista_DDMRP_fluxo, lista_de_materiais_DDMRP, base_dir, r"4.Relatorios Python", "DEMANDA_QUALIFICADA.xlsx", "D1")
    def_exportar_vetor(arr_ESTOQUE, lista_DDMRP_fluxo, lista_de_materiais_DDMRP, base_dir, r"4.Relatorios Python", "ESTOQUE.xlsx", "D1")
    def_exportar_vetor(arr_FLUXO_LIQUIDO, lista_DDMRP_fluxo, lista_de_materiais_DDMRP, base_dir, r"4.Relatorios Python", "FLUXO_LIQUIDO.xlsx", "D1")

    #Exportar vetores em D0
    def_exportar_vetor(arr_DAF, lista_DDMRP_fluxo, lista_de_materiais_DDMRP, base_dir, r"4.Relatorios Python", "DAF.xlsx", "D0")
    def_exportar_vetor(arr_planejado, lista_DDMRP_fluxo, lista_de_materiais_DDMRP, base_dir, r"4.Relatorios Python", "planejado.xlsx", "D0")
    def_exportar_vetor(arr_planejado_entrega, lista_DDMRP_fluxo, lista_de_materiais_DDMRP, base_dir, r"4.Relatorios Python", "planejado_entrega.xlsx", "D0")

    #Exportar vetores com ATRASO
    def_exportar_vetor(arr_reservas_completo, lista_DDMRP_fluxo, lista_de_materiais_DDMRP, base_dir, r"4.Relatorios Python", "reservas.xlsx", "ATRASO")
    def_exportar_vetor(arr_OCs_OPs, lista_DDMRP_fluxo, lista_de_materiais_DDMRP, base_dir, r"4.Relatorios Python", "OCs_OPs.xlsx", "ATRASO")
    def_exportar_vetor(arr_NIPs_completo, lista_DDMRP_fluxo, lista_de_materiais_DDMRP, base_dir, r"4.Relatorios Python", "nips_tempo.xlsx", "ATRASO")
    ...
    def_exportar_planejado_PBI(df_dados_mestres, df_custo, df_parametros,
                               ...
                               lista_de_materiais_DDMRP, data_ref, base_dir, r"2.Historico")
